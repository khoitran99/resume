                ...
                <button
                  ...
                  className={`flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
                    isActive
                      ...
                      : "text-slate-600 dark:text-slate-400 hover:bg-slate-100/50 dark:text-slate-300 dark:hover:bg-slate-800/50"
                  }`}
                >
                  <Icon
        ...
        <button
          ...
          className={`group relative flex items-center justify-center w-12 h-12 rounded-full cursor-pointer transition-all duration-300 backdrop-blur-xl border shadow-lg ${
            isOpen || background !== "none"
              ...
              : "bg-white/80 dark:bg-slate-900/80 text-primary-600 border-white/60 dark:border-slate-800 dark:bg-slate-900/80 dark:text-white dark:border-slate-700 hover:bg-primary-600 hover:text-white"
