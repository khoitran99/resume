...
export const projectsVi: ProjectEntry[] = [
  {
    ...
    role: "Trưởng kỹ thuật dự án",
    period: "Tháng 03/2025 – Tháng 03/2026",
    teamSize: "10",
    summary:
  ...
  },
  {
    ...
    role: "Kỹ sư Phần mềm Full-Stack cấp cao",
    period: "Tháng 11/2024 – Tháng 07/2025",
    teamSize: "20+",
    summary:
  ...
  {
    id: "cablenet",
    title: "Cablenet - Nền tảng lập kế hoạch đi cáp mạng",
    role: "Kỹ sư Phần mềm Full-Stack cấp cao",
    period: "Tháng 08/2025 – Tháng 03/2026",
    teamSize: null,
    summary:
      "Cablenet là nền tảng lập kế hoạch và tài liệu hóa hệ thống cáp mạng, tự động tạo các bảng Excel có cấu trúc từ các tệp đầu vào thiết bị theo tầng. Hỗ trợ upload file, đếm port, nhóm MDF/IDF, nhập chiều dài cáp FO, chọn IDF CCTV, tải xuống lịch đã tạo và lưu lịch sử phiên.",
    contributions: [
      "Xây dựng và nâng cấp quy trình backend tạo file Excel, bao gồm bảng thiết bị, bảng port, bảng rack, hàng sàn nâng/chống tĩnh điện, sheet passive, active network/AP và sheet tổng hợp.",
      "Triển khai hỗ trợ đa IDF theo tầng với đếm port theo khu vực, kiểm tra nhóm IDF, quy tắc gán MDF/IDF và lưu trữ phiên.",
      "Phát triển tính năng quản lý thiết bị master: CRUD API, sắp xếp/lọc/tìm kiếm, import Excel, xóa mềm/khôi phục và nhật ký thay đổi thiết bị.",
      "Thêm logic IDF CCTV bao gồm tổng hợp port CCTV, kiểm tra và tích hợp vào quy trình tạo file.",
      "Tích hợp S3 presigned URL upload/download, theo dõi lịch sử tạo file và dọn dẹp các file đã hết hạn.",
      "Hỗ trợ xác thực và quản lý người dùng với Keycloak, bao gồm đăng nhập, CRUD người dùng, đặt lại mật khẩu, thông báo email và kiểm soát quyền truy cập admin.",
    ],
    techStack: [
      "React",
      "TypeScript",
    ...
    caseStudy: {
      challenge: [
        "Tài liệu hóa cáp mạng yêu cầu quy trình thủ công tốn thời gian, dễ xảy ra lỗi và khó mở rộng quy mô cho các bố cục tòa nhà phức tạp với nhiều tầng và vùng IDF.",
        "Các dự án cần theo dõi hàng chục loại thiết bị, nhóm MDF/IDF, đếm port và tuyến cáp trong định dạng có thể sử dụng trực tiếp bởi nhà thầu và các bên liên quan.",
        "Quản lý trạng thái phiên, lịch sử tạo file, vai trò người dùng và xác thực giữa các nhóm đòi hỏi kiến trúc backend đáng tin cậy.",
      ],
      approach: [
        "Xây dựng backend Spring Boot WebFlux để quản lý thiết bị master, tạo bảng Excel nhiều sheet từ bản vẽ mặt bằng đã upload và lưu lịch sử tạo file lên AWS S3.",
        "Triển khai các quy tắc đặc thù về nhóm MDF/IDF, đếm port theo khu vực, hỗ trợ đa IDF mỗi tầng và chọn IDF CCTV có kiểm tra.",
        "Tích hợp Keycloak cho xác thực dựa trên vai trò, đảm bảo chỉ admin truy cập được các thao tác nhạy cảm và hỗ trợ CRUD người dùng cùng thông báo email.",
      ],
      impact: [
        "Tự động hóa việc tạo bảng Excel phức tạp bao gồm thiết bị, port, rack, sheet passive/active và tổng hợp — loại bỏ hoàn toàn tài liệu thủ công.",
        "Cho phép quản lý toàn vòng đời từ upload file đến tạo lịch, tải xuống và lưu lịch sử phiên.",
        "Giảm đáng kể thời gian tài liệu hóa cáp mạng thủ công trên nhiều cấu hình tòa nhà.",
      ],
    },
  },
  {
