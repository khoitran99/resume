...
export const projects: ProjectEntry[] = [
  ...
  {
    id: "cablenet",
    title: "Cablenet - Network Cabling Planning Platform",
    role: "Senior Full-Stack Software Engineer",
    period: "August 2025 – March 2026",
    teamSize: null,
    summary:
      "Cablenet is a network cabling planning and documentation platform that generates structured Excel schedules from floor equipment input files. It supports file upload, port counting, MDF/IDF grouping, FO cable length entry, CCTV IDF selection, generated schedule downloads, and session history.",
    contributions: [
      "Built and enhanced backend workflows for Excel-based file generation, covering equipment, port, rack, raised-floor, passive, active network/AP sheets, and summary sheets.",
      "Implemented multi-IDF-per-floor support with area-based port counting, IDF grouping validation, MDF/IDF assignment rules, and session persistence.",
      "Developed equipment master management with CRUD APIs, sorting/filtering/search, Excel import, soft delete/restore, and equipment change history logs.",
      "Added CCTV IDF logic including port summary, validation, and integration into the file generation workflow.",
      "Integrated S3 presigned upload/download URLs, generation history tracking, and cleanup of expired generated files.",
      "Supported authentication and user management with Keycloak, including login, user CRUD, password reset, email notifications, and admin-only access checks.",
    ],
    techStack: [
      "React",
      "TypeScript",
    ...
    caseStudy: {
      challenge: [
        "Network cabling documentation required time-consuming manual processes that were error-prone and difficult to scale across complex building layouts with multiple floors and IDF zones.",
        "Projects needed to track dozens of equipment types, MDF/IDF groupings, port counts, and cabling runs in a format directly consumable by contractors and stakeholders.",
        "Managing session state, file generation history, user roles, and authentication across teams required a reliable backend architecture.",
      ],
      approach: [
        "Built a Spring Boot WebFlux backend to manage equipment masters, generate multi-sheet Excel schedules from uploaded floor plans, and persist generation history to AWS S3.",
        "Implemented domain-specific rules for MDF/IDF grouping, area-based port counting, multi-IDF-per-floor support, and CCTV IDF selection with validation.",
        "Integrated Keycloak for role-based authentication, ensuring admin-only access to sensitive operations while supporting user CRUD and email notifications.",
      ],
      impact: [
        "Automated generation of complex Excel schedules covering equipment, ports, racks, passive/active sheets, and summary views — eliminating manual documentation.",
        "Enabled full lifecycle management from file upload through schedule generation, download, and persistent session history.",
        "Reduced manual cabling documentation time significantly across multiple building configurations.",
      ],
    },
  },
  {
